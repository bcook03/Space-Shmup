...
public class Enemy_3 : Enemy
{
    ...
    [Tooltip("If true, the Bezier pints & path are drawn in the Scene pane.")]
    ...
    void Start() {
        ...
        // Set xMin and xMax the same way that Mian.SpawnEnemy() does
        float xMin = -bndCheck.camWidth + bndCheck.radius;
        float xMax = bndCheck.camWidth - bndCheck.radius;

        //Pick a random middle position in the bottom hald of the screen
        ...
        // Set the birthTime to yhe currnet time
        birthTime = Time.time;
