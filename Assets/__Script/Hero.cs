...
public class Hero : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       // Use the fireEveent to fire Weapons when the Spacebar is pressed.
    ...
    /// </summary> 
    /// <returns> THe dirst empty Weapon slot or null if none are empty</returns>
    ...
    /// <summary>
    //  Sets the type if all Weapon slots to none
    // </summary>
