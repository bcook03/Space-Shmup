...
/// Items marked [NI] belolw are Not Implemented in this book.
/// </summary>
...
//  of a specific weappon in the Inspector. The Main class has
...
public class WeaponDefinition {
    ...
    [Tooltip("Damge caused when a single Projectile hits an Enemy ")]
...
public class Weapon : MonoBehaviour
{
    ...
    [Header("DYNAMIC")]
    [SerializeField]
    [Tooltip("Setthing this manually while playing does not work properly.")]
    ...
    void Start()
    {
        // Set up PROJECTILE_ANCOR if it has not already been done
    ...
    public void SetType(eWeaponType wt) {
        ...
        // Destroy any old model and then attcah a model for this weapon
