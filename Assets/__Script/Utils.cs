...
public class Utils : MonoBehaviour
{
    ...
    //  any number of points using his recursive function.
    // </summary>
    ...
    static public Vector3 Bezier(float u, params Vector3[] points) {
        ...
        // Fill the last row of vArr with the elments of vList
        ...
        // When complete, vArr[0,0] holds the interpolated value
        return vArr[0,0];
    }
    ...
    /// </summary>
    /// <param name="go">The GameObject on whicdh to search for Renderers</param>
    static public Material[] GetAllMaterials( GameObject go ) {
        Renderer[] rend = go.GetComponentsInChildren<Renderer>();
